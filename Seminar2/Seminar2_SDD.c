...
// Vectorul este static ca v[100]daca avem nr exact de date iar dinamic prin v* .
struct Calculator
{
	char* serie;
	float pret;
...
Calculatorul cu seria 1234567890 ,costa 10.00 si are 1 porturi
Calculatorul cu seria 1234567890 ,costa 30.00 si are 2 porturi
Calculatorul cu seria 1234567890 ,costa 50.00 si are 3 porturi
Calculatorul cu seria 1234567890 ,costa 70.00 si are 4 porturi
Calculatorul cu seria 1234567890 ,costa 90.00 si are 5 porturi
